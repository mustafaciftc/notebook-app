...
const RegisterScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        if (isSuccess) {
            Alert.alert("Başarılı", "Hesabınız başarıyla oluşturuldu! Giriş yapabilirsiniz.");
            navigation.navigate("Login");
        }

        dispatch(reset());
    }, [isLoading, isError, isSuccess, message, navigation, dispatch]);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.formContainer}>
                ...
                <Text style={styles.subtitle}>Hemen başlamak için bilgilerinizi girin</Text>
